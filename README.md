...
**[clinic-database]** is an sql project for creating a database to store animal information
...
```sh
  cd my-folder
  git clone git@github.com:AbdelazizSoliman/clinic-database.git
```
...
- Twitter: [@twitterhandle](https://twitter.com/Abdelaz21958317/)
